...
function App() {
  ...
  useEffect(() => {
    ...
    const requestResize = () => {
      if (!isSurfaceVisible() || resizeFrame) return;
    ...
    const onDocumentVisibility = () => {
      if (isSurfaceVisible()) requestSettledResize();
    };
      ...
      <div className="popover-current-surface" onPointerMove={onSurfacePointerMove}>
        <div className="popover-current-scroll">
          ...
          <div className="popover-view-shell">
            ...
            >
              <PopoverSystemPanel t={t} snapshot={snapshot} selection={selection} setSelection={setSelection} active={surfaceVisible && popoverView === "system"} />
            </section>
            <section
